...
def check_proxy_config():
    ...
    if not proxy_url_config:
        ...
        print("   例如：export TEMU_API_PROXY_URL=http://your-proxy-server:8001")
        print("\n2. 或者在 .env 文件中添加：")
        print("   TEMU_API_PROXY_URL=http://your-proxy-server:8001")
        print("\n3. 如果使用 Docker，在 docker-compose.yml 中添加环境变量")
        return False
    else:
